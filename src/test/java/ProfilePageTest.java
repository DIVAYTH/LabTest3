...
public class ProfilePageTest implements UtilsTest {
    ...
    /**
     * Сценарий 8 - авторизованный пользователь хочет посмотреть список своих вопросов<br>
    ...
    /**
     * Сценарий 9 - авторизованный пользователь хочет посмотреть список ответов на свои вопросы<br>
     * 1.Пользователь авторизуется<br>
     * 2.Пользователь жмет на кнопку профиля<br>
     * 3.Пользователь ждет прогрузки и попадает в свой профиль<br>
    ...
    /**
     * Сценарий 10 - авторизованный пользователь хочет посмотреть информацию о своих подписчиков<br>
     * 1.Пользователь авторизуется<br>
     * 2.Пользователь жмет на кнопку профиля<br>
     * 3.Пользователь ждет прогрузки и попадает в свой профиль<br>
